...
START_TEST(test_memcmp_11) {
  ...
  char str2[] = "1234";
  s21_size_t n1 = 5;
  int res1 = s21_memcmp(str1, str2, n1);
  int res2 = memcmp(str1, str2, n1);
  ck_assert_msg((res1 == 0 && res2 == 0) || (res1 < 0 && res2 < 0) ||
                    (res1 > 0 && res2 > 0),
                "Sign mismatch: s21_memcmp=%d, memcmp=%d", res1, res2);
}
END_TEST
